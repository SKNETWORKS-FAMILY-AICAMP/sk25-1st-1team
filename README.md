...
**박범수**
> 2주간 배운 내용을 실제 Streamlit 대시보드로 설계하고 구현하는 과정에서 배운 이론을 실전에 적용하는 어려움을 체감했습니다. 하지만 오류를 하나씩 고쳐가며 기능을 완성해낸 경험은 앞으로 또 다가오는 프로젝트를 하는데 자신감을 얻게 되었습니다.

<br>

**이수영**
> 대주제에서 ‘KLACI 지자체 유형’이라는 아이디어로 주제를 구체화하며 차별점을 만들어가는 과정에서 기획 단계의 중요성을 체감했습니다. 이후 데이터 분석과 웹 크롤링을 통해 빈틈을 보완하며, 문제를 정의하고 해결해 나가는 과정 자체가 중요하다는 것을 깨달았습니다. Streamlit 구현을 반복하며 UX와 정보 흐름을 설계하는 재미도 느낄 수 있었고, 팀원 간 소통을 주도하며 PM 역할에 한 발 다가섰음을 실감한 프로젝트였습니다.

<br>

**이하윤**
> 수업시간에는 발생하지 않았던 오류들 때문에 당황하기도 했고, 배운 부분에서도 막상 시도하려 하니 막히는 부분이 많아 어려움을 겪기도 했지만 이러한 과정 속에서 스스로 문제를 해결하는 방법을 고민해 볼 수 있었고, 단순히 이해했다고 생각했던 내용들을 다시 한 번 점검할 수 있는 의미 있는 시간이었습니다. 또한 좋은 팀원들과 함께 끝까지 프로젝트를 완료할 수 있어 더욱 뜻깊었습니다.  
