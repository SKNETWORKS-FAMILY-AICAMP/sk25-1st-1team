...
**최현우**
<br>
사람의 mbti를 지역 mbti로 바꾼 사이트에서 데이터를 추출해 자동차등록 대수와 연관지어 분석을 한게 흥미로웠다.
...
**김찬영**
<br>
조원 모두 함께 주제 선정을 하기 위해 의견을 내고, 각 데이터 수집, 크롤링, DB에 저장하는 것까지 누가 요청하지 않아도 각자의 장점을 살려 더 잘할 수 있는 부분에서 힘 쓰는 모습이  너무 좋았습니다. 누구 한 빠지지 않고 열심히 한 덕분에 큰 어려움 없이 짧은 시간에 완수해야 하는 미니 프로젝트를 원하는 결과만큼 만들어 낼 수 있었습니다.
