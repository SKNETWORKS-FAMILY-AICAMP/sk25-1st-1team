...
### 👤 이수영
- 주제에서 ‘KLACI 지자체 유형’이라는 아이디어로 주제를 구체화하며 차별점을 만들어가는 과정에서 기획 단계의 중요성을 체감했습니다. 이후 데이터 분석과 웹 크롤링을 통해 빈틈을 보완하며, 문제를 정의하고 해결해 나가는 과정 자체가 중요하다는 것을 깨달았습니다. Streamlit 구현을 반복하며 UX와 정보 흐름을 설계하는 재미도 느낄 수 있었고, 팀원 간 소통을 주도하며 PM 역할에 한 발 다가섰음을 실감한 프로젝트였습니다.
